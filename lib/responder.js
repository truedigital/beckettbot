...
Responder.prototype.getResponse = function(text) {
	...
	if (theText === "beckettbot help") {
		return ">Hello, I am *beckett* bot.\n"
				...
				+">I also love *rap* and *hip hop*.\n"
				+">Any more for anymore?\n"
				+">Back to work then.";
	}
	else if (theText.indexOf("beckett rap") > -1 || theText.indexOf("hip-hop") > -1 || theText.indexOf("rap") > -1 || theText.indexOf("hip hop") > -1) {
